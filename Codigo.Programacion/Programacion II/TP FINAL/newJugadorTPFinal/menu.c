...
void iniciarMenu(celda deportes[], int validos, int dimension,arbolEntrenador* master)
{
    int salida;
    do
    {
        ...
        salida = switchMenuPrincipal(deportes,validos,dimension,master);
    }
    while(salida != 0);
}
...
void switchSubMenuADMIN(celda deportes[], int validos, int dimension, arbolEntrenador* master)
{
    int op;
    do
    {
        ...
        case 0:
            ...
            printf ("\n\n");
            imprimirOpcionesMenuPrincipal();
            switchMenuPrincipal(deportes,validos,dimension,master);
        case 1: ///Dependiendo de lo que se necesite en cada case se puede llamar a un submenu o a una funcion en especifico
            ...
            switchSubMenuAdminJugador(deportes,validos,dimension,master);
            system("pause");
            break;
        case 2:
            system ("cls");
            ...
            switchSubMenuAdminEntrenador(deportes,validos,dimension,master);
            system("pause");
            break;
        case 3:
            system ("cls");
...
int switchMenuPrincipal(celda deportes[], int validos, int dimension,arbolEntrenador* master)
{
    int op;
    do
    {
        ...
        case 1:
            ...
            switchSubMenuADMIN(deportes,validos, dimension,master);
            break;
        case 2:
            system("cls");
            imprimirCabecera("ENTRENADORES");
            ...
            switchSubMenuENTRENADOR(deportes,validos,dimension,master);
            break;
        default:
            printf("Opcion incorrecta\n");
...
int switchSubMenuENTRENADOR(celda deportes[], int validos, int dimension,arbolEntrenador* master)
{
    int op;
    do
    {
...
int switchSubMenuAdminJugador(celda deportes[], int validos, int dimension,arbolEntrenador* master)
{
...
int switchSubMenuAdminEntrenador(celda deportes[], int validos, int dimension,arbolEntrenador* master)
{
    int op;
    do
    {
